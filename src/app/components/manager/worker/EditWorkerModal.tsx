...
import { SingleWorker } from '@/services/worker/type';
import { useUpdateWorkerMutation } from '@/services/worker/useWorker';
interface EditManagerModalProps {
    isOpen: boolean;
    onClose: () => void;
    manager: SingleWorker | null;
}

const EditWorker = ({ isOpen, onClose, manager }: EditManagerModalProps) => {
    ...
    const { mutate, isLoading } = useUpdateWorkerMutation();
    ...
    const { mutateAsync: getAllworker } = useGetAllManagersMutation();
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-end gap-4 mt-4">
                ...
                <Button onClick={handleSubmit} disabled={isLoading} className='bg-[#4FD1C5] text-white'>
