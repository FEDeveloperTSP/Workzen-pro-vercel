...
import ShiftAttendanceOfManagerComponent from "./ShiftAttendanceOfManagerComponent"

const months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]

const ShiftAttendanceOfManager = () => {
  ...
  console.log("manager shifts data ", shifts)
  ...
  return (
    <div className="p-4 overflow-x-auto w-full">
      ...
      <ShiftAttendanceOfManagerComponent
...
export default ShiftAttendanceOfManager
